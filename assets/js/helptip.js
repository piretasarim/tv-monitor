...
/**
 * <a class="HelpLink" href="javascript:void(0)" onclick="showHelpTip(event, '<b>Plesk</b><br><br>is a control panel made by the Parallels company. Aplus.net supplies Plesk as a platform independent Gui that make the administration of Domains, E-mail, Statistics simpler than administrating the Operating system itself.'); return false">Plesk</a>
 * @param  {[type]} e            [description]
 * @param  {[type]} sHtml        [description]
 * @param  {[type]} bHideSelects [description]
